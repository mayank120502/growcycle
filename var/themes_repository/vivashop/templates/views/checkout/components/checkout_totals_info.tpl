<ul class="ty-cart-statistic ty-statistic-list">
    <li class="ty-cart-statistic__item ty-statistic-list-subtotal">
        ...
        <span class="ty-cart-statistic__value et-price">{include file="common/price.tpl" value=$cart.display_subtotal}</span>
    </li>
    ...
    {hook name="checkout:checkout_totals"}
        ...
        {if $cart.shipping}
            ...
            <span class="ty-cart-statistic__value et-price">{include file="common/price.tpl" value=$cart.display_shipping_cost}</span>
    ...
    <li class="ty-cart-statistic__item ty-statistic-list-discount">
        ...
        <span class="ty-cart-statistic__value discount-price et-price">{include file="common/price.tpl" value="-`$cart.discount`"}</span>
    </li>
    ...
    <li class="ty-cart-statistic__item ty-statistic-list-subtotal-discount">
        ...
        <span class="ty-cart-statistic__value discount-price et-price">{include file="common/price.tpl" value="-`$cart.subtotal_discount`"}</span>
    </li>
    ...
    <li class="ty-cart-statistic__item ty-statistic-list-tax">
        ...
        <span class="ty-cart-statistic__value et-price">{include file="common/price.tpl" value=$tax.tax_subtotal}</span>
    </li>
    {/foreach}
    {/if}
    ...
    <li class="ty-cart-statistic__item ty-statistic-list-payment-surcharge" id="payment_surcharge_line">
        ...
        <span class="ty-cart-statistic__value et-price">{include file="common/price.tpl" value=$cart.payment_surcharge span_id="payment_surcharge_value"}</span>
    </li>
