            ...
            <div class="ty-grid-list__item ty-quick-view-button__wrapper et-grid-item">
              ...
              {hook name="products:product_multicolumns_list"}
                ...
                <div class="et-grid-info-wrapper">
                  ...
                  <div class="et-grid-stock-rating clearfix{if $addons.cp_hide_product_info.hide_vendor_info_grid_list === "Y" && $addons.cp_hide_product_info.hide_control_grid_list === "Y"} no-border{/if}">
                  ...
                  {if $addons.cp_hide_product_info.hide_vendor_info_grid_list !== "Y"}
                    {hook name="products:category_grid_vendor"}
                    {/hook}
                  {/if}

                  {if $addons.cp_hide_product_info.hide_control_grid_list !== "Y"}
