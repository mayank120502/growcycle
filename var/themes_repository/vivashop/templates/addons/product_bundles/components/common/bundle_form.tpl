...
{if $bundle.products}
  ...
  {* Bundle form wrapper *}
  <div class="ty-product-bundles-bundle-form et-buy-together-wrapper"
  ...
  >
    ...
    {if $show_header && $bundle.storefront_name}
      <div class="ty-product-bundles-bundle-form__header ty-subheader et-buy-together__title">
    ...
    {if $show_description && $bundle.description}
      <div class="ty-product-bundles-bundle-form__description ty-wysiwyg-content et-buy-together__description">
        <p>{$bundle.description nofilter}</p>
      </div>
    {/if}
