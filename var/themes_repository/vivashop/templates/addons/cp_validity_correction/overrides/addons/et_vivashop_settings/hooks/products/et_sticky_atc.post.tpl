...
<div id="et-sticky-prod-wrapper" >
	...
	{assign var="obj_prefix" value="sticky_prod_"}
	{$sticky_prod=true}
	...
	{include file="common/product_data.tpl" 
		...
		et_review_link_scroll=true 
		et_hide_wishlist=true
		hide_other_offers_link=true
	}
		...
		<div class="et-sticky-left">
			...
			<div class="sticky-title">
				...
				<div class="et-flex">
					...
					{/if}
					{include file="addons/discussion/hooks/products/et_rating.post.tpl" obj_prefix=$obj_prefix}
				</div>
			</div>
		</div>
