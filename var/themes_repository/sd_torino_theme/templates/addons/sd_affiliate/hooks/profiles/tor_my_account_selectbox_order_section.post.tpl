...
{if $user_type != "A"}
    <li class="tor-selectbox__item">
        <a class="tor-selectbox__option js-selectbox__option"
            href="{$url_menu_item_affiliate}"
            rel="nofollow"
        >
            <svg class="tor-selectbox__option-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
            ...
            <span class="tor-selectbox__option-text">
