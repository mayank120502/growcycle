        ...
        {if $login_type != "otp"}
            <div class="ty-control-group ty-password-forgot">
                ...
                {if $login_type == "password"}
                    <span data-ca-dispatch="dispatch[profiles.cp_check_otp]" data-ca-check-filter=".cp-otp-auth-field" data-ca-otp-action="recover" class="cp-recover-pass ty-password-forgot__a cm-submit cm-ajax cm-ajax-full-render" rel="nofollow" tabindex="5">{__("forgot_password_question")}</span>
                {else}
