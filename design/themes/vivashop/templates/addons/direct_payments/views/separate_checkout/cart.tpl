...
{if $carts}
    <h1 class="ty-mainbox-title {if $carts|count > 1}ty-mve-title{/if} et-direct-payments-cart-title-wrapper">
        <span class="et-direct-payments-cart-title">{__("cart_contents")}</span>
        {if $carts|count > 1}
    ...
    {/foreach}
{else}
    <p class="ty-no-items et-cart-page-empty">{__("text_cart_empty")}</p>
