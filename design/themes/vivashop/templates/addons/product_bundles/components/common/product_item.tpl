...
{if $bundle && $bundle_product}
  ...
  <div class="ty-product-bundles-product-item ty-scroller__item"
    ...
    <div class="ty-product-bundles-product-item__content ty-center">

      {* Product image *}
      <div class="ty-product-bundles-product-item__image ty-buy-together__product-image"
        ...
        >
          {include file="common/image.tpl"
            ...
            class="ty-product-bundles-product-item__image-content  ty-buy-together__product-image"
          }
        </a>
      ...
      <div class="ty-product-bundles-product-item__info">
        ...
        {* Product name *}
        <div class="ty-product-bundles-product-item__name1 ty-buy-together__product-name">
          <bdi>
            <a href="{"products.view?product_id=`$bundle_product.product_id`"|fn_url}"
              class="ty-product-bundles-product-item__name-link1 product-title"
            >
        ...
        {* Product price *}
        <div class="ty-product-bundles-product-item__price ty-buy-together__product-price"
