...
<form name="{$form_name}" action="{""|fn_url}" method="get" class="search-by-geodata">
    ...
    <div class="ty-product-filters__wrapper">
        ...
        <div class="ty-product-filters__tools clearfix">
            <a href="{"companies.catalog"|fn_url}" rel="nofollow" class="ty-btn ty-btn__secondary et-btn-icon-text ty-product-filters__reset-button">{include_ext file="common/icon.tpl" class="ty-icon-cw ty-product-filters__reset-icon"} {__("reset")}</a>
        </div>
    </div>
