				...
				<div class="ty-simple-list clearfix">
					...
					{else}
						<div class="et-info-wrapper">
							...
							{if "MULTIVENDOR"|fn_allowed_for && $addons.cp_hide_product_info.hide_vendor_info_products_scroller !== "Y"}
							...
							{if $addons.cp_hide_product_info.hide_control_products_scroller !== "Y"}
