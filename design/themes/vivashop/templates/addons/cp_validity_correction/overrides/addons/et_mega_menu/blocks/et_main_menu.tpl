...
{if $et_traditional_resp==true}
  ...
  {$et_menu_capture="et_menu_`$block.snapping_id`"}
  {capture name="et_menu_`$block.snapping_id`"}
  ...
  <div class="ty-menu visible-desktop">
    <ul id="vmenu_{$block.snapping_id}_desktop" class="ty-menu__items cm-responsive-menu{if $block.properties.right_to_left_orientation =="Y"} rtl{/if}">
  ...
  <div class="et-category-menu hidden-desktop">
    <div class="ty-menu">
      <ul id="vmenu_{$block.snapping_id}_mobile" class="ty-menu__items cm-responsive-menu{if $block.properties.right_to_left_orientation =="Y"} rtl{/if}">
...
{/if}
<div class="ty-menu">
  <ul id="vmenu_{$block.snapping_id}" class="ty-menu__items cm-responsive-menu{if $block.properties.right_to_left_orientation =="Y"} rtl{/if}">
    <li class="ty-menu__item ty-menu__menu-btn visible-phone visible-tablet">
      <div class="ty-menu__item-toggle hidden-desktop cm-responsive-menu-toggle ty-menu__item-toggle-active">
        <i class="ty-menu__icon-open et-icon-circle-plus"></i>
        <i class="ty-menu__icon-hide et-icon-circle-minus"></i>
