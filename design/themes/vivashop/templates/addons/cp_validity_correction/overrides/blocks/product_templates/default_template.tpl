...
{if $user_data.fields.60 && $user_data.fields.60 != ''}
<input type="hidden" value="{$user_data.fields.60}" id="fm_fm_product_atc" />
<div class="et-product-atc fm_product_atc" id="fm_add_to_from">
                                                                                                                                                                                    
                                                    
                	<a data-ca-dialog-class="send_lnquiry_popup{if $user_data.fields.60}1{/if}" class="ty-btn text-button et-btn-icon-text et-add-to-cart cp-additional-buying-types et-in-stock"
 id="cp_additional_add_btn_type_C_9924" href="{if $user_data.fields.60}{$user_data.fields.60}{/if}" target="blank" title="Send Inquiry"><i class="et-icon-mail"></i><span>Contact Supplier</span></a>                                            

{literal}
<style>
@media (min-width: 768px) {
.fm_product_atc {display:none}
}
@media (max-width: 768px) {
.et-product-atc {display:none}
.fm_product_atc  {display:block}
.fm_product_atc .et-product-atc  {display:block}
}
{/literal}
</style>											</div>
<script>
...
window.onload = function () {
	...
	document.getElementById('fm_add_to').innerHTML =  document.getElementById('fm_add_to_from').innerHTML;
} 
...
{/if}
									...
									<div>
										...
										<div class="clearfix">
											...
											<div class="et-product-atc" id="fm_add_to">
