                ...
                <div class="ty-orders__actions">
                    ...
                    <div class="ty-orders__actions-right">
                        {if $view_only != "Y"}
                            ...
                            {/hook}
                        {/if}
                        {if $order_info.cp_buying_type === "Addons\\CpNewBuyingTypes\\ProductBuyingTypes::BUY"|enum}
                        ...
                        {hook name="orders:totals"}
                            ...
                            {hook name="orders:order_total"}
                                <tr class="ty-orders-summary__row">
                                    ...
                                    <td class="ty-orders-summary__total et-orders-summary__total-price" data-ct-orders-summary="summary-total">{include file="common/price.tpl" value=$order_info.total}</td>
                                </tr>
                            {/hook}
                        {/hook}
                    </table>
...
{capture name="mainbox_title"}
    <span class="et-order-info-wrapper"><span class="et-order-info-text"><span class="et-order-info-number">{__("order")}&nbsp;<bdi>#{$order_info.order_id}</bdi></span>
            <em class="ty-date">({$order_info.timestamp|date_format:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"})</em></span>
        <span class="et-order-info-status">
            <em class="ty-status">{__("status")}: <strong>{include file="common/status.tpl" status=$order_info.status display="view" name="update_order[status]"}</strong></em>
        </span></span>
{/capture}
