...
<div id="account_info_{$block.snapping_id}">
    ...
    <div class="ty-account-info__buttons buttons-container">
        ...
        {else}
            <a href="{"cp_nbt_login.start_login?return_url=`$return_current_url`"|fn_url}" data-ca-target-id="cp_nbt_login_popup"
               class="cm-dialog-opener cm-dialog-auto-size ty-btn ty-btn__primary" rel="nofollow">{__("sign_in")}</a>
            <a href="{"profiles.add"|fn_url}" rel="nofollow" class="ty-btn ty-btn__secondary">{__("register")}</a>
        {/if}
    </div>
