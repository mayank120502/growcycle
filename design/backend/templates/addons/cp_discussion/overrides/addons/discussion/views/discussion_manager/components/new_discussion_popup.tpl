    ...
    {capture name="add_new_picker"}
        ...
        <form id='form' action="{""|fn_url}" method="post" class="form-horizontal form-edit cm-disable-empty-files" enctype="multipart/form-data">
            ...
            <div class="cm-tabs-content cm-no-hide-input" id="content_tab_add_post">
                ...
                <div class="control-group" id="cp_time_update">
                    ...
                    <div class="controls">
                        {include file="addons/cp_discussion/common/calendar.tpl" 
                            date_id="post_data_timestamp" date_name="post_data[date]" 
                            date_val=$post_data.timestamp|default:$smarty.const.TIME 
                            start_year=$settings.Company.company_start_year 
                            show_time=true time_name="post_data[time]" 
                            type_time_name="post_data[time_type]" 
                            type_time_val=$post_data.time_type
                        }
                    </div>
                    <div class="controls">
                        <a href="{"discussion.generate_time"|fn_url}" class="cm-ajax btn" data-ca-target-id="cp_time_update">{__("cp_discussion.use_rnd_time")}</a>
                    </div>
                <!--cp_time_update--></div>
