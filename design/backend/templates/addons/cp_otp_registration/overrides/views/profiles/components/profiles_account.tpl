...
<div class="control-group">
    <label for="email" class="control-label cm-email cm-required">{__("email")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label for="phone" class="control-label cm-mask-phone-label ">{__("phone")}:</label>
    <div class="controls">
        <input type="text" id="phone" name="user_data[phone]" class="input-large cp-phone" size="32" maxlength="25" value="{$user_data.phone}" autocomplete="n"/>
        {if $user_data.cp_phone_verified == "Y"}
            <span class="cp-phone-status cp-confirmed"><i class="icon-ok"></i>&nbsp;{__("cp_phone_confirmed")}</span>
        {else}
            <span class="cp-phone-status cp-unconfirmed"><i class="icon-remove"></i>&nbsp;{__("cp_phone_unconfirmed")}</span>
        {/if}
    </div>
</div>
...
{if $auth.is_root != "Y" && $user_data.user_type == 'V'}
<div class="control-group">
    <label forTR="contact_support_url" class="control-label">{__("contact_support_url")}:</label>
    <div class="controls">
        <input type="text" id="contact_support_url" name="user_data[fields][60]" class="input-large" size="32" maxlength="128" value="{$user_data.fields.60}" />
    </div>
</div>
{/if}
