...
<div class="table-responsive-wrapper">
    ...
    {/if}
        ...
        <td class="row-status" data-th="{__("phone")}">{if $user.phone}<a class="row-status" href="tel:{$user.phone}">{$user.phone}</a>{else}--{/if}</td>
        ...
        <td class="row-status" data-th="{__("type")}">{if $user.user_type == "A"}{__("administrator")}{elseif $user.user_type == "V"}{__("vendor_administrator")}{elseif $user.user_type == "C"}{__("customer")}{elseif $user.user_type == "P"}{__("affiliate")}{/if}</td>
