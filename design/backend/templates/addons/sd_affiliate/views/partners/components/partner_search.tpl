<div class="sidebar-row">
    ...
    <div class="sidebar-field">
        <label for="elm_approved">{__("status")}:</label>
    ...
    <div class="sidebar-field">
        <label for="elm_plan_id">{__("plan")}:</label>
        <select name="plan_id" id="elm_plan_id">
            ...
            {if $general_affiliate_plans}{html_options options=$general_affiliate_plans selected=$search.plan_id}{/if}
        </select>
    </div>
    {/capture}
